...
from views.animal_requests import delete_animal, get_all_animals, get_animal_by_status, get_animals_by_location, get_single_animal, create_animal, update_animal
...
from views.employees_requests import create_employee, delete_employee, get_all_employees, get_employee_by_location, get_single_employee, update_employee
